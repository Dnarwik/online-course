            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h3>SELAMAT DATANG DI <br />KELAS LAKON</h3>
						<p>Disini kami menyediakan kelas untuk meningkatkan skill peserta. Silahkan klik mulai jika tertarik untuk mengikuti kelas kami.</p>
						<a class="main_btn" style="background: #170970; border: #170970;" href="#">Mulai</a>
					</div>
				</div>
            </div>
        </section>
        ...
        <section class="impress_area p_120">
        	<div class="container">
        		<div class="impress_inner text-center">
					<h2>Menjadi Pengajar</h2>
					<p>Ingin menjadi Pengajar disini? Silahkan daftar menjadi pengajar dengan klik tombol dibawah ini.</p>
					<a class="main_btn2" href="<?=base_url('welcome/pengajar')?>">Daftar</a>
        		</div>
        	</div>
        </section>
        <!--================End Impress Area =================-->
