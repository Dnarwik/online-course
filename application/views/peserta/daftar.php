<section class="banner_area">
        ...
        <div class="container">
          <div class="banner_content text-center">
            ...
            <div class="page_link">
              ...
              <a href="<?=base_url('peserta/Login/daftar')?>">Daftar</a>
            </div>
          </div>
        </div>
            </div>
      ...
      <section class="sample-text-area">
        <div class="container">
          <br>
          <h3 class="text-heading title_color"><center>DAFTAR PESERTA</center></h3>
          <div class="row">
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                <div class="single-defination">
                  <form action="<?=base_url('peserta/Login/buat_user')?>" method="post">
                    ...
                    <br>
                    <center><p>Sudah punya akun? Silahan masuk <a href="<?=base_url('welcome/peserta')?>">disini</a></p></center>
                  </form>
                </div>
              </div>
          </div>
